 ...
 */
public class CustomSftpReceiverRequesterUtil
{
    ...
    //private final List<String> polledFiles = new ArrayList<String>();
    

    public CustomSftpReceiverRequesterUtil(ImmutableEndpoint endpoint)
    {
    ...
    StorePolledFiles storePolledFiles = new StorePolledFiles();    
    ...
    public String[] getAvailableFiles(boolean onlyGetTheFirstOne) throws Exception
    {
        ...
        try
        {
            ...
            for (String file : files)
            {
                ...
                if (  storePolledFiles.isFileAlreadyProcessed( file )  )
                {
                	logger.info(" Skipping the processing of file: " + file + " . This file has already been processed.");
                    continue;
                }
                ...
                if (checkFileAge || sizeCheckDelayMs >= 0)
                {
                    ...
                    if (!hasChanged(file, client, fileAge, sizeCheckDelayMs))
                    {
                        ...
                        storePolledFiles.insertPolledFileToDB(file);
